...
export default {
  ...
  EMAIL_OR_PASSWORD_INVALID: 'Please check your Email or Password and Try Again.',
  ...
  REQUEST_RESET_PASSWORD_SUCCESSFULLY: 'Please check your Email to Reset Password',
  ...
  USER_NEED_NOT_SIGNUP: 'Users need not Signup. This is for Service Providers only.',
  ...
  END_TIME: 'End time',
  END_DATE_SHOULD_BE_GREATER: 'End date should be equal or greater than Start date',
  ...
  AVAILABLE_BEDS_LESS_THAN: 'Available beds should be less than or equal to Total Beds',
  ...
  ADDED_SUCCESSFULLY_AND_YOU_WANT_TO_CREATE_NEW: 'Service Added Successfully. Do you want to add another one?',
  ...
  NO_FAVORITES: 'No Favorites added. You can add a service to favorites by clicking on star at the top right of the service detail page.',
  NO_BEDS: 'Bed info not available on any existing shelter services.',
  CATEGORY: 'Category',
  CONTACT_SERVICE: 'Contact Service',
  NO_SERVICES_CLIENT: 'No results found matching your criteria in {{value}} tab. Please choose other Tabs at the bottom or Change your location or Choose different options in Side Menu.',
  NO_MANAGE_SERVICE: 'No services added. Please click on Add Services in Side Menu and then link to',
  ...
  ADDED_SUCCESSFULLY_AND_YOU_WANT_TO_CREATE_NEW_CRISLINES: 'Crisisline Added Successfully. Do you want to add another one?',
  YOU_REACHED_LIMIT_SERVICE: 'You reached the Max Limit for adding new services. Please check with App Admin at bigcountrynavigator@gmail.com to request access to add more services.',
  TEXT: 'TEXT',
  ...
  ADDED_SUCCESSFULLY_AND_YOU_WANT_TO_CREATE_NEW_LIAISON: 'Liaison Added Successfully. Do you want to add another one?',
  ...
  NO_FEEDBACKS: 'You don’t have any new feedback. Please check Archive tab for past feedback.',
  ...
  NO_MATCHING_RESULTS_FOUND: 'No matching results found. Please enter a different location.',
  CAN_NOT_GET_LOCATION: 'Can not current location. Go to Setting -> Open Location',
  ...
  NETWORK_REQUEST_FAILED: 'Can not connect to server. Please check your network.',
  DESCRIPTION: 'description',
  TITLE: 'Title',
  MESSAGE: 'Message',
  PLEASE_INPUT_AT_LEAST_ONE_COORDINATOR: 'Please input at least one Coordinator.',
  ...
  SLIDE_2_1: 'You can click on any service on the Home Screen to get detailed info including Bus Directions to that service from your Location. You can click on ',
  SLIDE_2_2: ' at the top right of details screen to add that service to My Favorites.',
  SLIDE_3:
  ...
  SLIDE_5: 'You can click on Crisis Lines in Options Menu to reach out to National Hotlines for emotional support. You can also search for Crisis Lines or Services using ',
  SLIDE_6: ' on Home screen for services will help you connect to the App Admin or Service Provider for that resource.',
  CLICKING: 'Clicking ',
  SLIDE_7_1: 'You can view services in List View or Map View and can even search for another City or Zip using ',
  SLIDE_7_2: ' at the top of Home Screen.',
  SLIDE_8: ' Home Screen for interacting with our AI Powered Chatbot to find services with ease',
  ACCEPT_TERMS: 'ACCEPT TERMS',
  SLIDE_9: "By Clicking I agree, you agree to the Finding Your Way in PA App, Inc's ",
  ...
  PH_SERVICE_DETAILS: 'Ex: Food Pantry, Emergency Shelter, HIV Test, Clothes, GED Training...',
