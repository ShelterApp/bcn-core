...
export default {
  ...
  NO_ECYEH: 'No services available to update bed information.',
  ACCEPT: 'Accept',
  ...
  // intro
  SKIP: 'SKIP',
  WELCOME_ECYEH: 'Big Country Navigator Intro',
  MILES: 'Miles',
  ...
  SLIDE_9:
    "By Clicking I agree, you agree to the Big Country Navigator Apps, ",
