...
export default {
    ...
    WEBSITE: "Website",
    SERVICES: "Services",
    SERVICE_TYPE: "Service Detail (Visible to Users)",
    ...
    NO_BEDS: "Bed info not available on any existing shelter services.",
    CATEGORY: "Category",
    ...
    NO_BCN: "No services available to update bed information.",
    ACCEPT: "Accept",
    ...
    REPORT_SERVICE_INFO: "Report Incorrect Service Information",
    CLAIM_SERVICE: "Claim Service to Manage",
    ...
    YOU_REACHED_LIMIT_SERVICE:
        "You reached the Max Limit for adding new services. Please check with App Admin at bigcountrynavigator@gmail.com to request access to add more services.",
    TEXT: "TEXT",
    ...
    REPORT_TITLE: "Report incorrect Info ?",
    CLAIM_TITLE: "Claim this Service",
    ...
    OPEN_STILL: "Open till",
    CLOSED_TILL_NEXT: "Closed till next",
    ...
    SLIDE_9:
        "By Clicking I agree, you agree to the Finding Your Way in PA App, Inc's ",
